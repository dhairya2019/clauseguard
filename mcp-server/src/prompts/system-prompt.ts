 ...
 *
 * The system prompt encodes all analysis logic extracted and condensed from:
 * - SKILL.md (8-step workflow, risk classification, framing rules, disclaimer)
 * - clause-patterns.md (risk trigger patterns, missing clause checklists, safer alternatives, edge cases)
 * - india-law.md (S.27, S.28, S.25, S.73-74, FEMA, jurisdiction, Copyright Act, Arbitration Act)
 *
 * The prompt instructs Claude to return structured JSON via the
 * `contract_analysis_result` tool -- NOT markdown.
 */

/**
 * Build the full system prompt for contract analysis.
 *
 * Returns a string of approximately 4000-6000 tokens encoding the complete
 * analysis logic, risk classification rules, India-specific legal rules,
 * framing rules, and disclaimer.
 */
